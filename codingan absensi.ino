//created bzgaming on tiktok live everyday everythings 
...
const char *GScriptId = "AKfycbzaM5PP7zOqWjIYlXQc9HBDrAPN2GVtp-vAvlrLw2lfPQj22rCeyZvQymGBeo7USqmCJg";
String gate_number = "Gate1";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "soljer";
